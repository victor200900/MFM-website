  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 text-center">
        ...
        >
          At <span className="font-semibold text-white">MFM Sanctuary of Grace</span>, our
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
          ...
          <div
            data-aos="fade-up"
            className="bg-purple-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 flex flex-col items-center text-center"
          >
          ...
          >
            <div className="bg-white/20 p-4 rounded-full mb-4">
              <FaBible className="text-white text-3xl" />
            </div>
            <h3 className="text-xl font-semibold text-white mb-2">
              The Word of God
            </h3>
